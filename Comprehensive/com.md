...
68：图片格式及无损压缩、有损压缩
------
<b>SVG(无损压缩，支持动画)<b><br/>
	1）矢量图形，文件较小，同时也能提供高清晰的画面，适合于直接打印或输出；<br/>
	2）图像文件可读，易于修改和编辑<br/>
	3）可以方便的创建文字索引，从而实现基于内容的图像搜索<br/>
	4）可以用来动态生成图形，也可以与现有技术互动融合<br/>
<b>JPEG(有损/无损)</b><br/>
	1）支持渐进传输，传输过程中图片从模糊到清晰<br/>
	2）支持高动态范围成像，支援图片透明度<br/>
<b>GIF(无损压缩，支持动画，8位压缩最多处理256种颜色)</b><br/>
	1）优秀的压缩算法使其在一定程度上保持了图像质量的同时将体积变得很小<br/>
	2）可插入多帧，从而实现动画效果<br/>
	3）可设置透明色以产生对象浮现于背景之上的效果<br/>
<b>PNG（无损压缩）</b><br/>
	1）分为8位，24位，32位。其中PNG24不支持透明<br/>
	2）渐进显示和流式读写<br/>
	3）保留图像名称、作者、版权、创作时间。<br/>
<br/>
